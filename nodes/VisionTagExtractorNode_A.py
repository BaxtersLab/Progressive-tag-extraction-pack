                ...
                json={
                    "messages": [{
                        ...
                        "content": [
                            ...
                            {"type": "text", "text": (
                                "Extract semantic tags from this image as a comma-separated list. "
                                "Include: subjects, objects present, actions happening, scene type, "
                                "setting, environment, and any notable elements. "
